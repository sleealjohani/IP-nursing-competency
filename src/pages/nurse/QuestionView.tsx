...
return <div className="question-wrap">
  ...
  <AnimatePresence mode="wait"><motion.div key={q.id} initial={{opacity:0,y:8}} animate={{opacity:1,y:0}} exit={{opacity:0,y:-6}} transition={{duration:.24}}><GlassCard className="question-card">
  ...
  </GlassCard></motion.div></AnimatePresence>
